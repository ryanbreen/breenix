...
- [context_switch.rs](../../kernel/src/arch_impl/aarch64/context_switch.rs#L1203):
  CPU 0 EL0 redirect guard
- [context_switch.rs](../../kernel/src/arch_impl/aarch64/context_switch.rs#L1696):
  ret-based resumed-thread dispatch used to avoid the "CPU 0 IRQ death" theory
- [context_switch.rs](../../kernel/src/arch_impl/aarch64/context_switch.rs#L1823):
  explicit pre-dispatch IRQ window and timer re-arm logic
- [context_switch.rs](../../kernel/src/arch_impl/aarch64/context_switch.rs#L1924):
...
Live traces from `<probe-environment>` on Ubuntu 24.04.4 ARM64 (`6.8.0-106-generic`)
under Parallels/HVF already establish the following:

Verified host-side bundles:

- [latest-smoke](<private-probe-log>)
- [20260402-073933](<private-probe-log>)
...
```bash
logs/<probe-environment>-cpu0/YYYYMMDD-HHMMSS/
```
...
- [20260402-1454-live](../../logs/breenix-parallels-cpu0/20260402-1454-live)
...
- artifact root:
  - [fixed-state-303c91eb](../../logs/breenix-parallels-cpu0/fixed-state-303c91eb)

Per-run summary:

| Run | Artifact | Abort tid | Stable abort value | Stable pre-abort sequence |
|-----|----------|-----------|--------------------|---------------------------|
| 1 | [run1](../../logs/breenix-parallels-cpu0/fixed-state-303c91eb/run1) | 13 | `ELR=x30=0x3b9aca00` | `EINTR s1/s2/s3/s5/s6 -> WAIT s0 -> 13->idle -> idle->13 -> timer -> abort` |
| 2 | [run2](../../logs/breenix-parallels-cpu0/fixed-state-303c91eb/run2) | 11 | `ELR=x30=0x3b9aca00` | `EINTR s1/s2/s3/s5/s6 -> WAIT s0 -> 11->idle -> timer -> idle->11 -> timer -> abort` |
| 3 | [run3](../../logs/breenix-parallels-cpu0/fixed-state-303c91eb/run3) | 11 | `ELR=x30=0x3b9aca00` | `EINTR s1/s2/s3/s5/s6 -> WAIT s0 -> 11->idle -> idle->11 -> timer -> abort` |
| 4 | [run4](../../logs/breenix-parallels-cpu0/fixed-state-303c91eb/run4) | 11 | `ELR=x30=0x3b9aca00` | `EINTR s3/s5/s6 -> WAIT s0 -> 11->idle -> timer*3 -> idle->11 -> timer -> abort` |
| 5 | [run5](../../logs/breenix-parallels-cpu0/fixed-state-303c91eb/run5) | 13 | `ELR=x30=0x3b9aca00` | `EINTR s2/s3/s5/s6 on tid 11 -> WAIT s0 on tid 11 -> 11->idle -> timer*2 -> idle->13 -> timer -> abort` |
...
- artifact:
  - [20260403-faulting-cpu-dump](../../logs/breenix-parallels-cpu0/20260403-faulting-cpu-dump)
- result:
...
- probe artifact:
  - [20260403-eret-publish-probe](../../logs/breenix-parallels-cpu0/20260403-eret-publish-probe)
- result:
...
- probe artifact:
  - [20260403-dispatch-redirect-probe](../../logs/breenix-parallels-cpu0/20260403-dispatch-redirect-probe)
- result:
...
- probe artifact:
  - [20260403-pm-lock-owner-probe-long](../../logs/breenix-parallels-cpu0/20260403-pm-lock-owner-probe-long)
- result:
...
- probe artifact:
  - [20260403-schedule-resume-probe](../../logs/breenix-parallels-cpu0/20260403-schedule-resume-probe)
- result:
...
- Why active:
  - [20260403-dispatch-redirect-probe](../../logs/breenix-parallels-cpu0/20260403-dispatch-redirect-probe)
    recorded this branch
  - [20260403-pm-lock-owner-probe-long](../../logs/breenix-parallels-cpu0/20260403-pm-lock-owner-probe-long)
    reported it is not required for the canonical abort
- Next evidence needed:
...
- Artifacts:
  - [20260403-eret-slot20-probe](../../logs/breenix-parallels-cpu0/20260403-eret-slot20-probe)
  - [20260403-eret-slot20-probe-2](../../logs/breenix-parallels-cpu0/20260403-eret-slot20-probe-2)
- Question:
...
- Artifact:
  - [20260403-callerlr-probe](../../logs/breenix-parallels-cpu0/20260403-callerlr-probe)
- Question:
...
- Artifact:
  - [20260403-redeployed-clean-repro](../../logs/breenix-parallels-cpu0/20260403-redeployed-clean-repro)
- Result:
...
- Artifact:
  - [20260403-kernel-resume-irq-probe](../../logs/breenix-parallels-cpu0/20260403-kernel-resume-irq-probe)
- Question:
...
- Artifacts:
  - [20260403-raw-timer-frame-probe](../../logs/breenix-parallels-cpu0/20260403-raw-timer-frame-probe)
  - [20260403-raw-timer-frame-probe-quiet](../../logs/breenix-parallels-cpu0/20260403-raw-timer-frame-probe-quiet)
- Result:
...
- Artifacts:
  - [20260403-broadened-irq-classifier](../../logs/breenix-parallels-cpu0/20260403-broadened-irq-classifier)
  - [20260403-timer-entry-exit-probe](../../logs/breenix-parallels-cpu0/20260403-timer-entry-exit-probe)
  - [20260403-resched-slotx30-probe](../../logs/breenix-parallels-cpu0/20260403-resched-slotx30-probe)
- Result:
...
- Artifact:
  - [20260403-resched-tail-live-probe](../../logs/breenix-parallels-cpu0/20260403-resched-tail-live-probe)
- Result:
...
- Source-level observation:
  - in [boot.S](../../kernel/src/arch_impl/aarch64/boot.S),
...
- First clean artifact after fixing the temporary `x17` restore regression:
  - [20260403-nested-slot-fix-test2](../../logs/breenix-parallels-cpu0/20260403-nested-slot-fix-test2)
- Result:
...
- Source-level observation:
  ...
  - the general interrupt-driven dispatch path in
    [context_switch.rs](../../kernel/src/arch_impl/aarch64/context_switch.rs)
...
- Primary validation artifact:
  - [20260403-inline-ret-dispatch-fix-test1](../../logs/breenix-parallels-cpu0/20260403-inline-ret-dispatch-fix-test1)
- Fixed-state follow-up sweep:
  - [fixed-state-inline-ret-dispatch/run2](../../logs/breenix-parallels-cpu0/fixed-state-inline-ret-dispatch/run2)
  - [fixed-state-inline-ret-dispatch/run3](../../logs/breenix-parallels-cpu0/fixed-state-inline-ret-dispatch/run3)
  - [fixed-state-inline-ret-dispatch/run4](../../logs/breenix-parallels-cpu0/fixed-state-inline-ret-dispatch/run4)
- Cross-run result:
  ...
  - one run regressed into a distinct new failure:
    - [run4](../../logs/breenix-parallels-cpu0/fixed-state-inline-ret-dispatch/run4)
...
- First validation artifact:
  - [20260403-fstat-copyout-fix-test1](../../logs/breenix-parallels-cpu0/20260403-fstat-copyout-fix-test1)
- Initial result:
...
- Failure that exposed it:
  - [fixed-state-ahci-timeout-trace/run5](../../logs/breenix-parallels-cpu0/fixed-state-ahci-timeout-trace/run5)
...
- Validation sweep:
  - [fixed-state-inline-ret-ttbr0](../../logs/breenix-parallels-cpu0/fixed-state-inline-ret-ttbr0)
- Result:
...
- Validation sweep:
  - [fixed-state-cached-ttbr0](../../logs/breenix-parallels-cpu0/fixed-state-cached-ttbr0)
- Cross-run result:
  - 4/5 runs reached the good baseline:
    - `bsshd: listening on 0.0.0.0:2222`
    - `[timer] cpu0 ticks=5000`
  - the one remaining bad run still timed out in AHCI:
    - [run2](../../logs/breenix-parallels-cpu0/fixed-state-cached-ttbr0/run2)
...
- Validation sweep:
  - [fixed-state-no-cpu0-guard](../../logs/breenix-parallels-cpu0/fixed-state-no-cpu0-guard)
- Result:
...
1. Use [fixed-state-cached-ttbr0/run2](../../logs/breenix-parallels-cpu0/fixed-state-cached-ttbr0/run2)
...
- Fixed-state probe:
  - [fixed-state-cpu0-user-dispatch](../../logs/breenix-parallels-cpu0/fixed-state-cpu0-user-dispatch)
- Result:
  ...
  - the ninth run reproduced the remaining timeout branch:
    - [run9](../../logs/breenix-parallels-cpu0/fixed-state-cpu0-user-dispatch/run9)
...
- Artifact:
  - [no-cpu0-guard-user-dispatch-probe/run1](../../logs/breenix-parallels-cpu0/no-cpu0-guard-user-dispatch-probe/run1)
- Result:
...
- Probe artifacts:
  - [guarded-asm-breadcrumb-probe/run10](../../logs/breenix-parallels-cpu0/guarded-asm-breadcrumb-probe/run10)
  - [guarded-asm-breadcrumb-probe-batch2/run4](../../logs/breenix-parallels-cpu0/guarded-asm-breadcrumb-probe-batch2/run4)
- Probe design:
...
- Cross-artifact result:
  ...
  - the same two runs end with:
    - `cpu0_dispatch: tid=11 elr=0xffff0000400fda64 spsr=0x5`
      on [run10](../../logs/breenix-parallels-cpu0/guarded-asm-breadcrumb-probe/run10)
    - `cpu0_dispatch: tid=10 elr=0xffff0000400fda64 spsr=0x5`
      on [run4](../../logs/breenix-parallels-cpu0/guarded-asm-breadcrumb-probe-batch2/run4)
  - `0xffff0000400fda64` resolves to `idle_loop_arm64`
  - the last sampled CPU0 timer PCs differ across the two bad runs:
    - [run10](../../logs/breenix-parallels-cpu0/guarded-asm-breadcrumb-probe/run10):
      `cpu0_last_timer_elr=0xffff0000400c0bf0`
      inside `AhciBlockDevice::read_block()`
    - [run4](../../logs/breenix-parallels-cpu0/guarded-asm-breadcrumb-probe-batch2/run4):
...
- Probe artifact:
  - [guarded-asm-breadcrumb-probe-111/run1](../../logs/breenix-parallels-cpu0/guarded-asm-breadcrumb-probe-111/run1)
- Probe design:
...
- Probe artifacts:
  - [guarded-asm-breadcrumb-sp/run4](../../logs/breenix-parallels-cpu0/guarded-asm-breadcrumb-sp/run4)
  - [guarded-asm-breadcrumb-elr-slot/run3](../../logs/breenix-parallels-cpu0/guarded-asm-breadcrumb-elr-slot/run3)
- Results:
...
- Validation sweep:
  - [fixed-state-inline-frame-relocation](../../logs/breenix-parallels-cpu0/fixed-state-inline-frame-relocation)
- Cross-run result:
  - 5/5 runs were clean
  - all 5 runs had:
    - `soft_lockup=0`
...
- Validation sweep:
  - [no-cpu0-guard-after-frame-relocation](../../logs/breenix-parallels-cpu0/no-cpu0-guard-after-frame-relocation)
- Result:
  - [run1](../../logs/breenix-parallels-cpu0/no-cpu0-guard-after-frame-relocation/run1)
    reached `cpu0 ticks=5000` cleanly
  - [run2](../../logs/breenix-parallels-cpu0/no-cpu0-guard-after-frame-relocation/run2)
  ...
  - [run3](../../logs/breenix-parallels-cpu0/no-cpu0-guard-after-frame-relocation/run3)
...
- Probe artifacts:
  - [no-guard-defer-requeue-probe/run1](../../logs/breenix-parallels-cpu0/no-guard-defer-requeue-probe/run1)
  - [no-guard-defer-requeue-probe/run2](../../logs/breenix-parallels-cpu0/no-guard-defer-requeue-probe/run2)
  - [no-guard-defer-requeue-probe/run4-long](../../logs/breenix-parallels-cpu0/no-guard-defer-requeue-probe/run4-long)
- Results:
...
- Trustworthy artifacts:
  - [post-deploy-current-kernel-run1](../../logs/breenix-parallels-cpu0/post-deploy-current-kernel-run1)
  - [post-deploy-current-kernel-sweep1/run1](../../logs/breenix-parallels-cpu0/post-deploy-current-kernel-sweep1/run1)
  - [post-deploy-current-kernel-sweep1/run2](../../logs/breenix-parallels-cpu0/post-deploy-current-kernel-sweep1/run2)
  - [post-deploy-current-kernel-sweep1/run3](../../logs/breenix-parallels-cpu0/post-deploy-current-kernel-sweep1/run3)
- Results:
...
- Probe artifacts:
  - [post-deploy-completion-chain-sweep/run1](../../logs/breenix-parallels-cpu0/post-deploy-completion-chain-sweep/run1)
  - [post-deploy-completion-chain-sweep/run3](../../logs/breenix-parallels-cpu0/post-deploy-completion-chain-sweep/run3)
...
- Probe artifacts:
  - [post-deploy-active-cmd-probe/run1](../../logs/breenix-parallels-cpu0/post-deploy-active-cmd-probe/run1)
  - [post-deploy-active-cmd-probe/run2](../../logs/breenix-parallels-cpu0/post-deploy-active-cmd-probe/run2)
...
- Linux probe reference:
  - `/proc/interrupts` on `<probe-environment>` shows the same Parallels AHCI device on
...
- Probe artifact:
  - [post-deploy-breadcrumb-daif-probe/run1](../../logs/breenix-parallels-cpu0/post-deploy-breadcrumb-daif-probe/run1)
- Result:
...
- Probe artifacts:
  - [post-deploy-ahci-priority-test/run1](../../logs/breenix-parallels-cpu0/post-deploy-ahci-priority-test/run1)
  - [post-deploy-ahci-priority-test/run2](../../logs/breenix-parallels-cpu0/post-deploy-ahci-priority-test/run2)
  - [post-deploy-ahci-priority-test/run3](../../logs/breenix-parallels-cpu0/post-deploy-ahci-priority-test/run3)
  - [post-deploy-ahci-priority-test/run4](../../logs/breenix-parallels-cpu0/post-deploy-ahci-priority-test/run4)
  - [post-deploy-ahci-priority-test/run5](../../logs/breenix-parallels-cpu0/post-deploy-ahci-priority-test/run5)
- Result:
...
- Local source facts:
  - generic ARM64 IRQ dispatch lives in:
    - [exception.rs](../../kernel/src/arch_impl/aarch64/exception.rs)
  - generic hardirq accounting helpers live in:
    - [per_cpu_aarch64.rs](../../kernel/src/per_cpu_aarch64.rs)
    - [percpu.rs](../../kernel/src/arch_impl/aarch64/percpu.rs)
  - `irq_enter()` / `irq_exit()` are currently called only by:
    - [timer_interrupt.rs](../../kernel/src/arch_impl/aarch64/timer_interrupt.rs)
- Concrete divergence:
...
- Probe artifacts:
  - [post-deploy-generic-hardirq-accounting/run1](../../logs/breenix-parallels-cpu0/post-deploy-generic-hardirq-accounting/run1)
  - [post-deploy-generic-hardirq-accounting/run2](../../logs/breenix-parallels-cpu0/post-deploy-generic-hardirq-accounting/run2)
  - [post-deploy-generic-hardirq-accounting/run3](../../logs/breenix-parallels-cpu0/post-deploy-generic-hardirq-accounting/run3)
  - [post-deploy-generic-hardirq-accounting/run4](../../logs/breenix-parallels-cpu0/post-deploy-generic-hardirq-accounting/run4)
  - [post-deploy-generic-hardirq-accounting/run5](../../logs/breenix-parallels-cpu0/post-deploy-generic-hardirq-accounting/run5)
- Result:
...
- Probe artifacts:
  - [post-deploy-timer-early-admission/run1](../../logs/breenix-parallels-cpu0/post-deploy-timer-early-admission/run1)
  - [post-deploy-timer-early-admission/run2](../../logs/breenix-parallels-cpu0/post-deploy-timer-early-admission/run2)
  - [post-deploy-timer-early-admission/run3](../../logs/breenix-parallels-cpu0/post-deploy-timer-early-admission/run3)
  - [post-deploy-timer-early-admission/run4](../../logs/breenix-parallels-cpu0/post-deploy-timer-early-admission/run4)
  - [post-deploy-timer-early-admission/run5](../../logs/breenix-parallels-cpu0/post-deploy-timer-early-admission/run5)
- Result:
...
- Probe artifacts:
  - [post-deploy-narrow-admission-fatal-postmortem/run1](../../logs/breenix-parallels-cpu0/post-deploy-narrow-admission-fatal-postmortem/run1)
  - [post-deploy-narrow-admission-fatal-postmortem/run2](../../logs/breenix-parallels-cpu0/post-deploy-narrow-admission-fatal-postmortem/run2)
  - [post-deploy-narrow-admission-fatal-postmortem/run3](../../logs/breenix-parallels-cpu0/post-deploy-narrow-admission-fatal-postmortem/run3)
  - [post-deploy-narrow-admission-fatal-postmortem/run4](../../logs/breenix-parallels-cpu0/post-deploy-narrow-admission-fatal-postmortem/run4)
  - [post-deploy-narrow-admission-fatal-postmortem/run5](../../logs/breenix-parallels-cpu0/post-deploy-narrow-admission-fatal-postmortem/run5)
- Fixed-state image:
...
- Probe artifacts:
  - [post-deploy-narrow-admission-fatal-postmortem-long60/run1](../../logs/breenix-parallels-cpu0/post-deploy-narrow-admission-fatal-postmortem-long60/run1)
  - [post-deploy-narrow-admission-fatal-postmortem-long60/run2](../../logs/breenix-parallels-cpu0/post-deploy-narrow-admission-fatal-postmortem-long60/run2)
  - [post-deploy-narrow-admission-fatal-postmortem-long60/run3](../../logs/breenix-parallels-cpu0/post-deploy-narrow-admission-fatal-postmortem-long60/run3)
- Method:
...
- Probe change summary:
  ...
  - kept the narrowed timer-body window in
    [timer_interrupt.rs](<local-checkout>)
    unchanged as baseline
- Artifacts:
  - [run1](../../logs/breenix-parallels-cpu0/p2-eoimode1-split/run1)
  - [run2](../../logs/breenix-parallels-cpu0/p2-eoimode1-split/run2)
  - [run3](../../logs/breenix-parallels-cpu0/p2-eoimode1-split/run3)
  - [run4](../../logs/breenix-parallels-cpu0/p2-eoimode1-split/run4)
  - [run5](../../logs/breenix-parallels-cpu0/p2-eoimode1-split/run5)
- Result:
...
- Probe change summary:
  - set `ICC_CTLR_EL1.EOImode` bit 1 to `1` in
    [gic.rs](../../kernel/src/arch_impl/aarch64/gic.rs)
...
- Probe change summary:
  ...
  - removed the bespoke context-switch admission/rearm scaffolding from
    [context_switch.rs](<local-checkout>)
