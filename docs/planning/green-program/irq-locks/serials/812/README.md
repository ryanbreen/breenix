...
Provenance for the 13 artifacts beside this file, all captured 2026-09-05 on
...
claim-lint:ok: 13 of 13 files beside this README have a row below.
...
| `06-aarch64-prod-profile.txt` | `docker/qemu/run-aarch64-prod-profile-boot-test.sh`: PASS, with the boot_tests-only oracle markers at count 0. Captured before the cosmetic line that echoes the IRQ-hold count was added to the same script's success output; the assertion it reports on was already in place for this run |
