    ...
    match request.method.as_str() {
        "tools/list" => {
            let tools = vec![
                ...
                Tool {
                    name: "breenix_running".to_string(),
                ...
                Tool {
                    name: "breenix_wait_prompt".to_string(),
                ...
                Tool {
                    name: "breenix_run_command".to_string(),
