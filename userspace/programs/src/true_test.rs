...
//!
//! Verifies that /sbin/true exits with code 0 and produces no output.
...
fn main() {
    ...
    // Test 1: /sbin/true should exit with 0 and produce no output
    println!("Test 1: /sbin/true exits with 0 and no output");
    {
