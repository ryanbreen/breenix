...
/// claim-lint:ok: the observed effect of the refusal this replaced
/// (`[FORK_SMOKE:FORK_FAILED ENOMEM]`) is in the pre-fix negative control,
/// and the post-fix markers are in the passing run:
