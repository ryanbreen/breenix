...
fn strand_census_progress_axes_and_ordering_cannot_shrink() {
    ...
    // claim-lint:ok: 1 of 3 boots failed the widening oracle on this, and the 9
    // observed cpu_silence_ms readings are in
    ...
    // named for CPU scheduler silence structurally unable to see the CPUs the
