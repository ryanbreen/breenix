...
pub(in crate::io::drivers::network::e1000) const MNG_VLAN_NONE: u16 = !(1);
pub(in crate::io::drivers::network::e1000) const MNG_DHCP_COOKIE_STATUS_PARSING_SUPPORT: u8 = 0x1; /* DHCP parsing enabled */
pub(in crate::io::drivers::network::e1000) const MNG_DHCP_COOKIE_STATUS_VLAN_SUPPORT: u8 = 0x2; /* DHCP parsing enabled */
pub(in crate::io::drivers::network::e1000) const VFTA_ENTRY_SHIFT: u8 = 0x5;
pub(in crate::io::drivers::network::e1000) const VFTA_ENTRY_MASK: u8 = 0x7F;
pub(in crate::io::drivers::network::e1000) const VFTA_ENTRY_BIT_SHIFT_MASK: u8 = 0x1F;
...
pub(in crate::io::drivers::network::e1000) const EEPROM_82544_APM: u16 = 0x0004;
...
pub(in crate::io::drivers::network::e1000) const ICR_TXDW: u32 = 0x00000001; /* Transmit desc written back */
pub(in crate::io::drivers::network::e1000) const ICR_TXQE: u32 = 0x00000002; /* Transmit Queue empty */
pub(in crate::io::drivers::network::e1000) const ICR_LSC: u32 = 0x00000004; /* Link Status Change */
pub(in crate::io::drivers::network::e1000) const ICR_RXSEQ: u32 = 0x00000008; /* rx sequence error */
pub(in crate::io::drivers::network::e1000) const ICR_RXDMT0: u32 = 0x00000010; /* rx desc min. threshold (0) */
pub(in crate::io::drivers::network::e1000) const ICR_RXO: u32 = 0x00000040; /* rx overrun */
pub(in crate::io::drivers::network::e1000) const ICR_RXT0: u32 = 0x00000080; /* rx timer intr (ring 0) */
pub(in crate::io::drivers::network::e1000) const ICR_MDAC: u32 = 0x00000200; /* MDIO access complete */
pub(in crate::io::drivers::network::e1000) const ICR_RXCFG: u32 = 0x00000400; /* RX /c/ ordered set */
pub(in crate::io::drivers::network::e1000) const ICR_GPI_EN0: u32 = 0x00000800; /* GP Int 0 */
pub(in crate::io::drivers::network::e1000) const ICR_GPI_EN1: u32 = 0x00001000; /* GP Int 1 */
pub(in crate::io::drivers::network::e1000) const ICR_GPI_EN2: u32 = 0x00002000; /* GP Int 2 */
pub(in crate::io::drivers::network::e1000) const ICR_GPI_EN3: u32 = 0x00004000; /* GP Int 3 */
pub(in crate::io::drivers::network::e1000) const ICR_TXD_LOW: u32 = 0x00008000;
pub(in crate::io::drivers::network::e1000) const ICR_SRPD: u32 = 0x00010000;
pub(in crate::io::drivers::network::e1000) const ICR_ACK: u32 = 0x00020000; /* Receive Ack frame */
pub(in crate::io::drivers::network::e1000) const ICR_MNG: u32 = 0x00040000; /* Manageability event */
pub(in crate::io::drivers::network::e1000) const ICR_DOCK: u32 = 0x00080000; /* Dock/Undock */
pub(in crate::io::drivers::network::e1000) const ICR_INT_ASSERTED: u32 = 0x80000000; /* If this bit asserted, the driver should claim the interrupt */
pub(in crate::io::drivers::network::e1000) const ICR_RXD_FIFO_PAR0: u32 = 0x00100000; /* queue 0 Rx descriptor FIFO parity error */
pub(in crate::io::drivers::network::e1000) const ICR_TXD_FIFO_PAR0: u32 = 0x00200000; /* queue 0 Tx descriptor FIFO parity error */
pub(in crate::io::drivers::network::e1000) const ICR_HOST_ARB_PAR: u32 = 0x00400000; /* host arb read buffer parity error */
pub(in crate::io::drivers::network::e1000) const ICR_PB_PAR: u32 = 0x00800000; /* packet buffer parity error */
pub(in crate::io::drivers::network::e1000) const ICR_RXD_FIFO_PAR1: u32 = 0x01000000; /* queue 1 Rx descriptor FIFO parity error */
pub(in crate::io::drivers::network::e1000) const ICR_TXD_FIFO_PAR1: u32 = 0x02000000; /* queue 1 Tx descriptor FIFO parity error */
pub(in crate::io::drivers::network::e1000) const ICR_ALL_PARITY: u32 = 0x03F00000; /* all parity error bits */
pub(in crate::io::drivers::network::e1000) const ICR_DSW: u32 = 0x00000020; /* FW changed the status of DISSW bit in the FWSM */
pub(in crate::io::drivers::network::e1000) const ICR_PHYINT: u32 = 0x00001000; /* LAN connected device generates an interrupt */
pub(in crate::io::drivers::network::e1000) const ICR_EPRST: u32 = 0x00100000; /* ME hardware reset occurs */

/* Interrupt Cause Set */
pub(in crate::io::drivers::network::e1000) const ICS_TXDW: u32 = ICR_TXDW; /* Transmit desc written back */
pub(in crate::io::drivers::network::e1000) const ICS_TXQE: u32 = ICR_TXQE; /* Transmit Queue empty */
pub(in crate::io::drivers::network::e1000) const ICS_LSC: u32 = ICR_LSC; /* Link Status Change */
pub(in crate::io::drivers::network::e1000) const ICS_RXSEQ: u32 = ICR_RXSEQ; /* rx sequence error */
pub(in crate::io::drivers::network::e1000) const ICS_RXDMT0: u32 = ICR_RXDMT0; /* rx desc min. threshold */
pub(in crate::io::drivers::network::e1000) const ICS_RXO: u32 = ICR_RXO; /* rx overrun */
pub(in crate::io::drivers::network::e1000) const ICS_RXT0: u32 = ICR_RXT0; /* rx timer intr */
pub(in crate::io::drivers::network::e1000) const ICS_MDAC: u32 = ICR_MDAC; /* MDIO access complete */
pub(in crate::io::drivers::network::e1000) const ICS_RXCFG: u32 = ICR_RXCFG; /* RX /c/ ordered set */
pub(in crate::io::drivers::network::e1000) const ICS_GPI_EN0: u32 = ICR_GPI_EN0; /* GP Int 0 */
pub(in crate::io::drivers::network::e1000) const ICS_GPI_EN1: u32 = ICR_GPI_EN1; /* GP Int 1 */
pub(in crate::io::drivers::network::e1000) const ICS_GPI_EN2: u32 = ICR_GPI_EN2; /* GP Int 2 */
pub(in crate::io::drivers::network::e1000) const ICS_GPI_EN3: u32 = ICR_GPI_EN3; /* GP Int 3 */
pub(in crate::io::drivers::network::e1000) const ICS_TXD_LOW: u32 = ICR_TXD_LOW;
pub(in crate::io::drivers::network::e1000) const ICS_SRPD: u32 = ICR_SRPD;
pub(in crate::io::drivers::network::e1000) const ICS_ACK: u32 = ICR_ACK; /* Receive Ack frame */
pub(in crate::io::drivers::network::e1000) const ICS_MNG: u32 = ICR_MNG; /* Manageability event */
pub(in crate::io::drivers::network::e1000) const ICS_DOCK: u32 = ICR_DOCK; /* Dock/Undock */
pub(in crate::io::drivers::network::e1000) const ICS_RXD_FIFO_PAR0: u32 = ICR_RXD_FIFO_PAR0; /* queue 0 Rx descriptor FIFO parity error */
pub(in crate::io::drivers::network::e1000) const ICS_TXD_FIFO_PAR0: u32 = ICR_TXD_FIFO_PAR0; /* queue 0 Tx descriptor FIFO parity error */
pub(in crate::io::drivers::network::e1000) const ICS_HOST_ARB_PAR: u32 = ICR_HOST_ARB_PAR; /* host arb read buffer parity error */
pub(in crate::io::drivers::network::e1000) const ICS_PB_PAR: u32 = ICR_PB_PAR; /* packet buffer parity error */
pub(in crate::io::drivers::network::e1000) const ICS_RXD_FIFO_PAR1: u32 = ICR_RXD_FIFO_PAR1; /* queue 1 Rx descriptor FIFO parity error */
pub(in crate::io::drivers::network::e1000) const ICS_TXD_FIFO_PAR1: u32 = ICR_TXD_FIFO_PAR1; /* queue 1 Tx descriptor FIFO parity error */
pub(in crate::io::drivers::network::e1000) const ICS_DSW: u32 = ICR_DSW;
pub(in crate::io::drivers::network::e1000) const ICS_PHYINT: u32 = ICR_PHYINT;
pub(in crate::io::drivers::network::e1000) const ICS_EPRST: u32 = ICR_EPRST;

/* Interrupt Mask Set */
pub(in crate::io::drivers::network::e1000) const IMS_TXDW: u32 = ICR_TXDW; /* Transmit desc written back */
pub(in crate::io::drivers::network::e1000) const IMS_TXQE: u32 = ICR_TXQE; /* Transmit Queue empty */
pub(in crate::io::drivers::network::e1000) const IMS_LSC: u32 = ICR_LSC; /* Link Status Change */
pub(in crate::io::drivers::network::e1000) const IMS_RXSEQ: u32 = ICR_RXSEQ; /* rx sequence error */
pub(in crate::io::drivers::network::e1000) const IMS_RXDMT0: u32 = ICR_RXDMT0; /* rx desc min. threshold */
pub(in crate::io::drivers::network::e1000) const IMS_RXO: u32 = ICR_RXO; /* rx overrun */
pub(in crate::io::drivers::network::e1000) const IMS_RXT0: u32 = ICR_RXT0; /* rx timer intr */
pub(in crate::io::drivers::network::e1000) const IMS_MDAC: u32 = ICR_MDAC; /* MDIO access complete */
pub(in crate::io::drivers::network::e1000) const IMS_RXCFG: u32 = ICR_RXCFG; /* RX /c/ ordered set */
pub(in crate::io::drivers::network::e1000) const IMS_GPI_EN0: u32 = ICR_GPI_EN0; /* GP Int 0 */
pub(in crate::io::drivers::network::e1000) const IMS_GPI_EN1: u32 = ICR_GPI_EN1; /* GP Int 1 */
pub(in crate::io::drivers::network::e1000) const IMS_GPI_EN2: u32 = ICR_GPI_EN2; /* GP Int 2 */
pub(in crate::io::drivers::network::e1000) const IMS_GPI_EN3: u32 = ICR_GPI_EN3; /* GP Int 3 */
pub(in crate::io::drivers::network::e1000) const IMS_TXD_LOW: u32 = ICR_TXD_LOW;
pub(in crate::io::drivers::network::e1000) const IMS_SRPD: u32 = ICR_SRPD;
pub(in crate::io::drivers::network::e1000) const IMS_ACK: u32 = ICR_ACK; /* Receive Ack frame */
pub(in crate::io::drivers::network::e1000) const IMS_MNG: u32 = ICR_MNG; /* Manageability event */
pub(in crate::io::drivers::network::e1000) const IMS_DOCK: u32 = ICR_DOCK; /* Dock/Undock */
pub(in crate::io::drivers::network::e1000) const IMS_RXD_FIFO_PAR0: u32 = ICR_RXD_FIFO_PAR0; /* queue 0 Rx descriptor FIFO parity error */
pub(in crate::io::drivers::network::e1000) const IMS_TXD_FIFO_PAR0: u32 = ICR_TXD_FIFO_PAR0; /* queue 0 Tx descriptor FIFO parity error */
pub(in crate::io::drivers::network::e1000) const IMS_HOST_ARB_PAR: u32 = ICR_HOST_ARB_PAR; /* host arb read buffer parity error */
pub(in crate::io::drivers::network::e1000) const IMS_PB_PAR: u32 = ICR_PB_PAR; /* packet buffer parity error */
pub(in crate::io::drivers::network::e1000) const IMS_RXD_FIFO_PAR1: u32 = ICR_RXD_FIFO_PAR1; /* queue 1 Rx descriptor FIFO parity error */
pub(in crate::io::drivers::network::e1000) const IMS_TXD_FIFO_PAR1: u32 = ICR_TXD_FIFO_PAR1; /* queue 1 Tx descriptor FIFO parity error */
pub(in crate::io::drivers::network::e1000) const IMS_DSW: u32 = ICR_DSW;
pub(in crate::io::drivers::network::e1000) const IMS_PHYINT: u32 = ICR_PHYINT;
pub(in crate::io::drivers::network::e1000) const IMS_EPRST: u32 = ICR_EPRST;

/* Interrupt Mask Clear */
pub(in crate::io::drivers::network::e1000) const IMC_TXDW: u32 = ICR_TXDW; /* Transmit desc written back */
pub(in crate::io::drivers::network::e1000) const IMC_TXQE: u32 = ICR_TXQE; /* Transmit Queue empty */
pub(in crate::io::drivers::network::e1000) const IMC_LSC: u32 = ICR_LSC; /* Link Status Change */
pub(in crate::io::drivers::network::e1000) const IMC_RXSEQ: u32 = ICR_RXSEQ; /* rx sequence error */
pub(in crate::io::drivers::network::e1000) const IMC_RXDMT0: u32 = ICR_RXDMT0; /* rx desc min. threshold */
pub(in crate::io::drivers::network::e1000) const IMC_RXO: u32 = ICR_RXO; /* rx overrun */
pub(in crate::io::drivers::network::e1000) const IMC_RXT0: u32 = ICR_RXT0; /* rx timer intr */
pub(in crate::io::drivers::network::e1000) const IMC_MDAC: u32 = ICR_MDAC; /* MDIO access complete */
pub(in crate::io::drivers::network::e1000) const IMC_RXCFG: u32 = ICR_RXCFG; /* RX /c/ ordered set */
pub(in crate::io::drivers::network::e1000) const IMC_GPI_EN0: u32 = ICR_GPI_EN0; /* GP Int 0 */
pub(in crate::io::drivers::network::e1000) const IMC_GPI_EN1: u32 = ICR_GPI_EN1; /* GP Int 1 */
pub(in crate::io::drivers::network::e1000) const IMC_GPI_EN2: u32 = ICR_GPI_EN2; /* GP Int 2 */
pub(in crate::io::drivers::network::e1000) const IMC_GPI_EN3: u32 = ICR_GPI_EN3; /* GP Int 3 */
pub(in crate::io::drivers::network::e1000) const IMC_TXD_LOW: u32 = ICR_TXD_LOW;
pub(in crate::io::drivers::network::e1000) const IMC_SRPD: u32 = ICR_SRPD;
pub(in crate::io::drivers::network::e1000) const IMC_ACK: u32 = ICR_ACK; /* Receive Ack frame */
pub(in crate::io::drivers::network::e1000) const IMC_MNG: u32 = ICR_MNG; /* Manageability event */
pub(in crate::io::drivers::network::e1000) const IMC_DOCK: u32 = ICR_DOCK; /* Dock/Undock */
pub(in crate::io::drivers::network::e1000) const IMC_RXD_FIFO_PAR0: u32 = ICR_RXD_FIFO_PAR0; /* queue 0 Rx descriptor FIFO parity error */
pub(in crate::io::drivers::network::e1000) const IMC_TXD_FIFO_PAR0: u32 = ICR_TXD_FIFO_PAR0; /* queue 0 Tx descriptor FIFO parity error */
pub(in crate::io::drivers::network::e1000) const IMC_HOST_ARB_PAR: u32 = ICR_HOST_ARB_PAR; /* host arb read buffer parity error */
pub(in crate::io::drivers::network::e1000) const IMC_PB_PAR: u32 = ICR_PB_PAR; /* packet buffer parity error */
pub(in crate::io::drivers::network::e1000) const IMC_RXD_FIFO_PAR1: u32 = ICR_RXD_FIFO_PAR1; /* queue 1 Rx descriptor FIFO parity error */
pub(in crate::io::drivers::network::e1000) const IMC_TXD_FIFO_PAR1: u32 = ICR_TXD_FIFO_PAR1; /* queue 1 Tx descriptor FIFO parity error */
...
pub(in crate::io::drivers::network::e1000) const RCTL_EN: u32 = 0x00000002; /* enable */
pub(in crate::io::drivers::network::e1000) const RCTL_SBP: u32 = 0x00000004; /* store bad packet */
pub(in crate::io::drivers::network::e1000) const RCTL_UPE: u32 = 0x00000008; /* unicast promiscuous enable */
pub(in crate::io::drivers::network::e1000) const RCTL_MPE: u32 = 0x00000010; /* multicast promiscuous enab */
pub(in crate::io::drivers::network::e1000) const RCTL_LPE: u32 = 0x00000020; /* long packet enable */
pub(in crate::io::drivers::network::e1000) const RCTL_LBM_NO: u32 = 0x00000000; /* no loopback mode */
pub(in crate::io::drivers::network::e1000) const RCTL_LBM_MAC: u32 = 0x00000040; /* MAC loopback mode */
pub(in crate::io::drivers::network::e1000) const RCTL_LBM_SLP: u32 = 0x00000080; /* serial link loopback mode */
pub(in crate::io::drivers::network::e1000) const RCTL_LBM_TCVR: u32 = 0x000000C0; /* tcvr loopback mode */
pub(in crate::io::drivers::network::e1000) const RCTL_DTYP_MASK: u32 = 0x00000C00; /* Descriptor type mask */
pub(in crate::io::drivers::network::e1000) const RCTL_DTYP_PS: u32 = 0x00000400; /* Packet Split descriptor */
pub(in crate::io::drivers::network::e1000) const RCTL_RDMTS_HALF: u32 = 0x00000000; /* rx desc min threshold size */
pub(in crate::io::drivers::network::e1000) const RCTL_RDMTS_QUAT: u32 = 0x00000100; /* rx desc min threshold size */
pub(in crate::io::drivers::network::e1000) const RCTL_RDMTS_EIGTH: u32 = 0x00000200; /* rx desc min threshold size */
pub(in crate::io::drivers::network::e1000) const RCTL_MO_SHIFT: u32 = 12; /* multicast offset shift */
pub(in crate::io::drivers::network::e1000) const RCTL_MO_0: u32 = 0x00000000; /* multicast offset 11:0 */
pub(in crate::io::drivers::network::e1000) const RCTL_MO_1: u32 = 0x00001000; /* multicast offset 12:1 */
pub(in crate::io::drivers::network::e1000) const RCTL_MO_2: u32 = 0x00002000; /* multicast offset 13:2 */
pub(in crate::io::drivers::network::e1000) const RCTL_MO_3: u32 = 0x00003000; /* multicast offset 15:4 */
pub(in crate::io::drivers::network::e1000) const RCTL_MDR: u32 = 0x00004000; /* multicast desc ring 0 */
pub(in crate::io::drivers::network::e1000) const RCTL_BAM: u32 = 0x00008000; /* broadcast enable */
/* these buffer sizes are valid if RCTL_BSEX is 0 */
pub(in crate::io::drivers::network::e1000) const RCTL_SZ_2048: u32 = 0x00000000; /* rx buffer size 2048 */
pub(in crate::io::drivers::network::e1000) const RCTL_SZ_1024: u32 = 0x00010000; /* rx buffer size 1024 */
pub(in crate::io::drivers::network::e1000) const RCTL_SZ_512: u32 = 0x00020000; /* rx buffer size 512 */
pub(in crate::io::drivers::network::e1000) const RCTL_SZ_256: u32 = 0x00030000; /* rx buffer size 256 */
/* these buffer sizes are valid if RCTL_BSEX is 1 */
pub(in crate::io::drivers::network::e1000) const RCTL_SZ_16384: u32 = 0x00010000; /* rx buffer size 16384 */
pub(in crate::io::drivers::network::e1000) const RCTL_SZ_8192: u32 = 0x00020000; /* rx buffer size 8192 */
pub(in crate::io::drivers::network::e1000) const RCTL_SZ_4096: u32 = 0x00030000; /* rx buffer size 4096 */
pub(in crate::io::drivers::network::e1000) const RCTL_VFE: u32 = 0x00040000; /* vlan filter enable */
pub(in crate::io::drivers::network::e1000) const RCTL_CFIEN: u32 = 0x00080000; /* canonical form enable */
pub(in crate::io::drivers::network::e1000) const RCTL_CFI: u32 = 0x00100000; /* canonical form indicator */
pub(in crate::io::drivers::network::e1000) const RCTL_DPF: u32 = 0x00400000; /* discard pause frames */
pub(in crate::io::drivers::network::e1000) const RCTL_PMCF: u32 = 0x00800000; /* pass MAC control frames */
pub(in crate::io::drivers::network::e1000) const RCTL_BSEX: u32 = 0x02000000; /* Buffer size extension */
pub(in crate::io::drivers::network::e1000) const RCTL_SECRC: u32 = 0x04000000; /* Strip Ethernet CRC */
pub(in crate::io::drivers::network::e1000) const RCTL_FLXBUF_MASK: u32 = 0x78000000; /* Flexible buffer size */
pub(in crate::io::drivers::network::e1000) const RCTL_FLXBUF_SHIFT: u32 = 27; /* Flexible buffer shift */
