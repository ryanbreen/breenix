...
impl Mapper {
        ...
        where A: FrameAllocator
    {
        ...
        //printk!("Mapping page {:?}, p1_index {:?}, to frame {:x}", page, page.p1_index(), frame.start_address());
        ...
        where A: FrameAllocator
    {
        ...
        //printk!("Identity mapping page {:?}, p1_index {:?}, to frame {:x}", page, page.p1_index(), frame.start_address());
        self.map_to(page, frame, flags, allocator)
    }
