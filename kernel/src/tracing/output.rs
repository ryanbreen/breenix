...
pub fn event_type_name(event_type: u16) -> &'static str {
    match event_type {
        ...
        virtgpu::VIRTGPU_FLUSH_READBACK_MISMATCH => "VIRTGPU_FLUSH_READBACK_MISMATCH",
        virtgpu::VIRTGPU_WAIT_TIMEOUT => "VIRTGPU_WAIT_TIMEOUT",
        virtgpu::BWM_COMPOSITE_FRAME_ENTER => "BWM_COMPOSITE_FRAME_ENTER",
        virtgpu::BWM_COMPOSITE_FRAME_EXIT => "BWM_COMPOSITE_FRAME_EXIT",
        virtgpu::VIRTGPU_FLUSH_ENTER => "VIRTGPU_FLUSH_ENTER",
        virtgpu::VIRTGPU_FLUSH_EXIT => "VIRTGPU_FLUSH_EXIT",
        virtgpu::VIRTGPU_SUBMIT_3D_ENTER => "VIRTGPU_SUBMIT_3D_ENTER",
        virtgpu::VIRTGPU_SUBMIT_3D_EXIT => "VIRTGPU_SUBMIT_3D_EXIT",
        virtgpu::VIRTGPU_WAIT_COMPLETION_ENTER => "VIRTGPU_WAIT_COMPLETION_ENTER",
        virtgpu::VIRTGPU_WAIT_COMPLETION_EXIT => "VIRTGPU_WAIT_COMPLETION_EXIT",
        ...
        TraceEventType::WAIT_TIMEOUT_STAGE => "WAIT_TIMEOUT_STAGE",
        TraceEventType::WAIT_TIMEOUT_SP => "WAIT_TIMEOUT_SP",
        TraceEventType::WAIT_TIMEOUT_X30 => "WAIT_TIMEOUT_X30",
        TraceEventType::EL1_INLINE_ABORT => "EL1_INLINE_ABORT",
        TraceEventType::EINTR_CHECK_STAGE => "EINTR_CHECK_STAGE",
        TraceEventType::EINTR_CHECK_X30 => "EINTR_CHECK_X30",
        TraceEventType::RET_DISPATCH_SP => "RET_DISPATCH_SP",
        TraceEventType::RET_DISPATCH_LR => "RET_DISPATCH_LR",
        TraceEventType::ERET_DISPATCH_STAGE => "ERET_DISPATCH_STAGE",
        TraceEventType::ERET_DISPATCH_ELR => "ERET_DISPATCH_ELR",
        TraceEventType::ERET_DISPATCH_X30 => "ERET_DISPATCH_X30",
        TraceEventType::ERET_DISPATCH_SPSR => "ERET_DISPATCH_SPSR",
        TraceEventType::CTX_PUBLISH_STAGE => "CTX_PUBLISH_STAGE",
        TraceEventType::CTX_PUBLISH_SP => "CTX_PUBLISH_SP",
        TraceEventType::CTX_PUBLISH_ELR => "CTX_PUBLISH_ELR",
        TraceEventType::CTX_PUBLISH_X30 => "CTX_PUBLISH_X30",
        TraceEventType::CTX_PUBLISH_FLAGS => "CTX_PUBLISH_FLAGS",
        TraceEventType::CTX_PUBLISH_AUX => "CTX_PUBLISH_AUX",
        TraceEventType::DISPATCH_REDIRECT => "DISPATCH_REDIRECT",
        TraceEventType::PM_LOCK_BUSY_CONTEXT => "PM_LOCK_BUSY_CONTEXT",
        TraceEventType::PM_LOCK_BUSY_OWNER => "PM_LOCK_BUSY_OWNER",
        TraceEventType::SCHEDULE_RESUME_STAGE => "SCHEDULE_RESUME_STAGE",
        TraceEventType::SCHEDULE_RESUME_SP => "SCHEDULE_RESUME_SP",
        TraceEventType::SCHEDULE_RESUME_X30 => "SCHEDULE_RESUME_X30",
        TraceEventType::WAIT_TIMEOUT_SLOT20 => "WAIT_TIMEOUT_SLOT20",
        TraceEventType::ERET_RESUME_INFO => "ERET_RESUME_INFO",
        TraceEventType::ERET_RESUME_SP => "ERET_RESUME_SP",
        TraceEventType::ERET_RESUME_SLOT20 => "ERET_RESUME_SLOT20",
        TraceEventType::KERNEL_RESUME_IRQ_INFO => "KERNEL_RESUME_IRQ_INFO",
        TraceEventType::KERNEL_RESUME_IRQ_ELR => "KERNEL_RESUME_IRQ_ELR",
        ...
        TraceEventType::CTX_DIAG_STAGE => "CTX_DIAG_STAGE",
        TraceEventType::CTX_DIAG_TID_PAIR => "CTX_DIAG_TID_PAIR",
        TraceEventType::CTX_DIAG_FRAME_ELR => "CTX_DIAG_FRAME_ELR",
        TraceEventType::CTX_DIAG_FRAME_X30 => "CTX_DIAG_FRAME_X30",
        TraceEventType::CTX_DIAG_THREAD_ELR => "CTX_DIAG_THREAD_ELR",
        TraceEventType::CTX_DIAG_THREAD_X30 => "CTX_DIAG_THREAD_X30",
        TraceEventType::CTX_DIAG_SP => "CTX_DIAG_SP",
        TraceEventType::CTX_DIAG_FLAGS => "CTX_DIAG_FLAGS",
        TraceEventType::SCHED_DIAG_STAGE => "SCHED_DIAG_STAGE",
        TraceEventType::SCHED_DIAG_TID_PAIR => "SCHED_DIAG_TID_PAIR",
        TraceEventType::SCHED_DIAG_FLAGS => "SCHED_DIAG_FLAGS",
        TraceEventType::FATAL_CPU_TRACE_MARKER => "FATAL_CPU_TRACE_MARKER",
...
fn payload_description(event_type: u16) -> &'static str {
    match event_type {
        ...
        virtgpu::VIRTGPU_FLUSH_READBACK_MISMATCH => "readback<<16|expected",
        virtgpu::VIRTGPU_WAIT_TIMEOUT => "resource_id<<16|cmd_type",
        virtgpu::BWM_COMPOSITE_FRAME_ENTER => "width<<16|height",
        virtgpu::BWM_COMPOSITE_FRAME_EXIT => "status",
        virtgpu::VIRTGPU_FLUSH_ENTER => "resource_id<<16|helper_id<<8|caller_tag",
        virtgpu::VIRTGPU_FLUSH_EXIT => "resource_id<<16|helper_id<<8|caller_tag",
        virtgpu::VIRTGPU_SUBMIT_3D_ENTER => "submit_id<<16|dwords",
        virtgpu::VIRTGPU_SUBMIT_3D_EXIT => "submit_id<<16|resp_type",
        virtgpu::VIRTGPU_WAIT_COMPLETION_ENTER => "resource_id<<16|cmd_type",
        virtgpu::VIRTGPU_WAIT_COMPLETION_EXIT => "resource_id<<16|cmd_type",
        ...
        TraceEventType::WAIT_TIMEOUT_STAGE => "stage<<16|tid",
        TraceEventType::WAIT_TIMEOUT_SP => "sp_low32",
        TraceEventType::WAIT_TIMEOUT_X30 => "x30_low32",
        TraceEventType::EL1_INLINE_ABORT => "x30_low32",
        TraceEventType::EINTR_CHECK_STAGE => "stage<<16|tid",
        TraceEventType::EINTR_CHECK_X30 => "x30_low32",
        TraceEventType::RET_DISPATCH_SP => "sp_low32",
        TraceEventType::RET_DISPATCH_LR => "slot20_low32",
        TraceEventType::ERET_DISPATCH_STAGE => "stage<<16|tid",
        TraceEventType::ERET_DISPATCH_ELR => "elr_low32",
        TraceEventType::ERET_DISPATCH_X30 => "x30_low32",
        TraceEventType::ERET_DISPATCH_SPSR => "spsr_low32",
        TraceEventType::CTX_PUBLISH_STAGE => "stage<<16|tid",
        TraceEventType::CTX_PUBLISH_SP => "sp_low32",
        TraceEventType::CTX_PUBLISH_ELR => "elr_low32",
        TraceEventType::CTX_PUBLISH_X30 => "x30_low32",
        TraceEventType::CTX_PUBLISH_FLAGS => "flags",
        TraceEventType::CTX_PUBLISH_AUX => "aux_low32",
        TraceEventType::DISPATCH_REDIRECT => "reason<<16|tid",
        TraceEventType::PM_LOCK_BUSY_CONTEXT => "owner_cpu<<16|req_tid",
        TraceEventType::PM_LOCK_BUSY_OWNER => "owner_tid_low32",
        TraceEventType::SCHEDULE_RESUME_STAGE => "stage<<16|tid",
        TraceEventType::SCHEDULE_RESUME_SP => "sp_low32",
        TraceEventType::SCHEDULE_RESUME_X30 => "x30_low32",
        TraceEventType::WAIT_TIMEOUT_SLOT20 => "slot20_low32",
        TraceEventType::ERET_RESUME_INFO => "tid",
        TraceEventType::ERET_RESUME_SP => "sp_low32",
        TraceEventType::ERET_RESUME_SLOT20 => "slot20_low32",
        TraceEventType::KERNEL_RESUME_IRQ_INFO => "kind<<16|tid",
        TraceEventType::KERNEL_RESUME_IRQ_ELR => "elr_low32",
        ...
        TraceEventType::CTX_DIAG_STAGE => "stage<<16|tid",
        TraceEventType::CTX_DIAG_TID_PAIR => "old_tid<<16|new_tid",
        TraceEventType::CTX_DIAG_FRAME_ELR => "frame_elr_low32",
        TraceEventType::CTX_DIAG_FRAME_X30 => "frame_x30_low32",
        TraceEventType::CTX_DIAG_THREAD_ELR => "thread_context_elr_low32",
        TraceEventType::CTX_DIAG_THREAD_X30 => "thread_context_x30_low32",
        TraceEventType::CTX_DIAG_SP => "sp_low32",
        TraceEventType::CTX_DIAG_FLAGS => "previous_tid<<16|flags",
        TraceEventType::SCHED_DIAG_STAGE => "stage<<16|tid",
        TraceEventType::SCHED_DIAG_TID_PAIR => "old_tid<<16|new_tid",
        TraceEventType::SCHED_DIAG_FLAGS => "flags",
        TraceEventType::FATAL_CPU_TRACE_MARKER => "kind",
        _ => "payload",
    }
}
