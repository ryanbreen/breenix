...
pub static CATALOG: &[BootTestDef] = &[
    ...
    BootTestDef {
        ...
        category: BootTestCategory::DriverInit,
    },
    BootTestDef {
        id: NIC_INIT,
        name: "nic_init",
    ...
    BootTestDef {
        id: SCHEDULER_INIT,
        name: "scheduler_init",
        category: BootTestCategory::Subsystem,
    },
    BootTestDef {
        id: KTHREAD_SUBSYSTEM,
        name: "kthread_subsystem",
        category: BootTestCategory::Subsystem,
    },
    BootTestDef {
        id: WORKQUEUE_INIT,
    ...
    // Userspace exec
    BootTestDef {
        id: USERSPACE_PROCESS_CREATE,
        name: "userspace_process_create",
        category: BootTestCategory::UserspaceExec,
    },
    BootTestDef {
        id: USERSPACE_ELF_LOAD,
        name: "userspace_elf_load",
        category: BootTestCategory::UserspaceExec,
    },
    BootTestDef {
        id: USERSPACE_FIRST_INSTRUCTION,
        name: "userspace_first_instruction",
        category: BootTestCategory::UserspaceExec,
    },
    BootTestDef {
        id: USERSPACE_FIRST_SYSCALL,
        name: "userspace_first_syscall",
        category: BootTestCategory::UserspaceExec,
    },
    // Boot tests framework
    BootTestDef {
        id: BOOT_TESTS_START,
        name: "boot_tests_start",
        category: BootTestCategory::Subsystem,
    },
    BootTestDef {
        id: BOOT_TESTS_COMPLETE,
        name: "boot_tests_complete",
        category: BootTestCategory::Subsystem,
    },
    // ARM64
    BootTestDef {
        id: AARCH64_MMU_INIT,
        name: "aarch64_mmu_init",
        category: BootTestCategory::KernelInit,
    },
    BootTestDef {
        id: AARCH64_EXCEPTION_VECTORS,
        name: "aarch64_exception_vectors",
        category: BootTestCategory::KernelInit,
    },
    BootTestDef {
        id: AARCH64_GIC_INIT,
    ...
    BootTestDef {
        id: AARCH64_TIMER_INIT,
        name: "aarch64_timer_init",
        category: BootTestCategory::KernelInit,
    },
    BootTestDef {
        id: AARCH64_UART_INIT,
        name: "aarch64_uart_init",
        category: BootTestCategory::KernelInit,
    },
    BootTestDef {
        id: AARCH64_FRAMEBUFFER_INIT,
        name: "aarch64_framebuffer_init",
        category: BootTestCategory::KernelInit,
    },
    // Userspace test results
    BootTestDef {
        id: UTEST_HELLO_TIME,
        name: "utest_hello_time",
        category: BootTestCategory::UserspaceResult,
    },
    BootTestDef {
        id: UTEST_CLOCK_GETTIME,
        name: "utest_clock_gettime",
        category: BootTestCategory::UserspaceResult,
    },
    BootTestDef {
        id: UTEST_BRK,
    ...
    BootTestDef {
        id: UTEST_SYSCALL_DIAGNOSTIC,
        name: "utest_syscall_diagnostic",
        category: BootTestCategory::UserspaceResult,
    },
    BootTestDef {
        id: UTEST_SIGNAL,
    ...
    BootTestDef {
        id: UTEST_SIGNAL_REGS,
        name: "utest_signal_regs",
        category: BootTestCategory::UserspaceResult,
    },
    BootTestDef {
        id: UTEST_SIGALTSTACK,
        name: "utest_sigaltstack",
        category: BootTestCategory::UserspaceResult,
    },
    BootTestDef {
        id: UTEST_PIPE,
    ...
    BootTestDef {
        id: UTEST_UNIX_SOCKET,
        name: "utest_unix_socket",
        category: BootTestCategory::UserspaceResult,
    },
    BootTestDef {
        id: UTEST_SIGCHLD,
    ...
    BootTestDef {
        id: UTEST_SHELL_PIPE,
        name: "utest_shell_pipe",
        category: BootTestCategory::UserspaceResult,
    },
    BootTestDef {
        id: UTEST_SIGNAL_EXEC,
        name: "utest_signal_exec",
        category: BootTestCategory::UserspaceResult,
    },
    BootTestDef {
        id: UTEST_WAITPID,
    ...
    BootTestDef {
        id: UTEST_SIGNAL_FORK,
        name: "utest_signal_fork",
        category: BootTestCategory::UserspaceResult,
    },
    BootTestDef {
        id: UTEST_WNOHANG_TIMING,
        name: "utest_wnohang_timing",
        category: BootTestCategory::UserspaceResult,
    },
    BootTestDef {
        id: UTEST_POLL,
    ...
    BootTestDef {
        id: UTEST_FORK_MEMORY,
        name: "utest_fork_memory",
        category: BootTestCategory::UserspaceResult,
    },
    BootTestDef {
        id: UTEST_FORK_STATE,
        name: "utest_fork_state",
        category: BootTestCategory::UserspaceResult,
    },
    BootTestDef {
        id: UTEST_FORK_PENDING_SIGNAL,
        name: "utest_fork_pending_signal",
        category: BootTestCategory::UserspaceResult,
    },
    BootTestDef {
        id: UTEST_COW_SIGNAL,
        name: "utest_cow_signal",
        category: BootTestCategory::UserspaceResult,
    },
    BootTestDef {
        id: UTEST_COW_CLEANUP,
        name: "utest_cow_cleanup",
        category: BootTestCategory::UserspaceResult,
    },
    BootTestDef {
        id: UTEST_COW_SOLE_OWNER,
        name: "utest_cow_sole_owner",
        category: BootTestCategory::UserspaceResult,
    },
    BootTestDef {
        id: UTEST_COW_STRESS,
        name: "utest_cow_stress",
        category: BootTestCategory::UserspaceResult,
    },
    BootTestDef {
        id: UTEST_COW_READONLY,
        name: "utest_cow_readonly",
        category: BootTestCategory::UserspaceResult,
    },
    BootTestDef {
        id: UTEST_ARGV,
    ...
    BootTestDef {
        id: UTEST_EXEC_ARGV,
        name: "utest_exec_argv",
        category: BootTestCategory::UserspaceResult,
    },
    BootTestDef {
        id: UTEST_EXEC_STACK_ARGV,
        name: "utest_exec_stack_argv",
        category: BootTestCategory::UserspaceResult,
    },
    BootTestDef {
        id: UTEST_FBINFO,
    ...
    BootTestDef {
        id: UTEST_UDP_SOCKET,
        name: "utest_udp_socket",
        category: BootTestCategory::UserspaceResult,
    },
    BootTestDef {
        id: UTEST_TCP_SOCKET,
        name: "utest_tcp_socket",
        category: BootTestCategory::UserspaceResult,
    },
    BootTestDef {
        id: UTEST_DNS,
    ...
    BootTestDef {
        id: UTEST_TRUE_COREUTIL,
        name: "utest_true_coreutil",
        category: BootTestCategory::UserspaceResult,
    },
    BootTestDef {
        id: UTEST_FALSE_COREUTIL,
        name: "utest_false_coreutil",
        category: BootTestCategory::UserspaceResult,
    },
    BootTestDef {
        id: UTEST_HEAD_COREUTIL,
        name: "utest_head_coreutil",
        category: BootTestCategory::UserspaceResult,
    },
    BootTestDef {
        id: UTEST_TAIL_COREUTIL,
        name: "utest_tail_coreutil",
        category: BootTestCategory::UserspaceResult,
    },
    BootTestDef {
        id: UTEST_WC_COREUTIL,
        name: "utest_wc_coreutil",
        category: BootTestCategory::UserspaceResult,
    },
    BootTestDef {
        id: UTEST_WHICH_COREUTIL,
        name: "utest_which_coreutil",
        category: BootTestCategory::UserspaceResult,
    },
    BootTestDef {
        id: UTEST_CAT_COREUTIL,
        name: "utest_cat_coreutil",
        category: BootTestCategory::UserspaceResult,
    },
    BootTestDef {
        id: UTEST_LS_COREUTIL,
        name: "utest_ls_coreutil",
        category: BootTestCategory::UserspaceResult,
    },
    BootTestDef {
        id: UTEST_HELLO_STD_REAL,
        name: "utest_hello_std_real",
        category: BootTestCategory::UserspaceResult,
    },
    BootTestDef {
        id: UTEST_FIFO,
    ...
    BootTestDef {
        id: UTEST_KILL_PROCESS_GROUP,
        name: "utest_kill_process_group",
        category: BootTestCategory::UserspaceResult,
    },
    BootTestDef {
        id: UTEST_EXEC_FROM_EXT2,
        name: "utest_exec_from_ext2",
        category: BootTestCategory::UserspaceResult,
    },
    BootTestDef {
        id: UTEST_FS_BLOCK_ALLOC,
        name: "utest_fs_block_alloc",
        category: BootTestCategory::UserspaceResult,
    },
    BootTestDef {
        id: UTEST_FS_WRITE,
    ...
    BootTestDef {
        id: UTEST_FS_RENAME,
        name: "utest_fs_rename",
        category: BootTestCategory::UserspaceResult,
    },
    BootTestDef {
        id: UTEST_FS_LARGE_FILE,
        name: "utest_fs_large_file",
        category: BootTestCategory::UserspaceResult,
    },
    BootTestDef {
        id: UTEST_FS_DIRECTORY,
        name: "utest_fs_directory",
        category: BootTestCategory::UserspaceResult,
    },
    BootTestDef {
        id: UTEST_FS_LINK,
    ...
    BootTestDef {
        id: UTEST_SIGNAL_KILL,
        name: "utest_signal_kill",
        category: BootTestCategory::UserspaceResult,
    },
    BootTestDef {
        id: UTEST_SIGNAL_RETURN,
        name: "utest_signal_return",
        category: BootTestCategory::UserspaceResult,
    },
    BootTestDef {
        id: UTEST_SIGNAL_HANDLER,
        name: "utest_signal_handler",
        category: BootTestCategory::UserspaceResult,
    },
    BootTestDef {
        id: UTEST_SYSCALL_ENOSYS,
        name: "utest_syscall_enosys",
        category: BootTestCategory::UserspaceResult,
    },
    BootTestDef {
        id: UTEST_UNIX_NAMED_SOCKET,
        name: "utest_unix_named_socket",
        category: BootTestCategory::UserspaceResult,
    },
    BootTestDef {
        id: UTEST_PIPE_FORK,
        name: "utest_pipe_fork",
        category: BootTestCategory::UserspaceResult,
    },
    BootTestDef {
        id: UTEST_PIPE_CONCURRENT,
        name: "utest_pipe_concurrent",
        category: BootTestCategory::UserspaceResult,
    },
    BootTestDef {
