...
fn create_fork_test_elf() -> alloc::vec::Vec<u8> {
    ...
    let code = vec![
        ...
        0x00, // mov rsi, 0x10001000 (string address)
...
pub fn test_syscall_enosys() {
    ...
    match crate::process::creation::create_user_process(
        ...
        Err(e) => {
            ...
            // Log message that CI test infrastructure looks for
            log::warn!("Unknown syscall number: 999 - returning ENOSYS (test marker for CI)");
