...
fn create_minimal_valid_elf() -> alloc::vec::Vec<u8> {
    ...
    // p_filesz (8 bytes) = 50 (code + data section)
    elf.extend_from_slice(&[0x32, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00]);
    ...
    elf.extend_from_slice(&[
        ...
        0x48, 0x8d, 0x35, 0x1a, 0x00, 0x00, 0x00, // lea rsi, [rip+0x1a] (string)
