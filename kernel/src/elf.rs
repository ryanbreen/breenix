...
// Note: load_elf and load_elf_at_base removed as they were unused.
// Use load_elf_into_page_table for loading ELF binaries.

// Note: load_segment removed as it was only used by the removed load_elf function.
