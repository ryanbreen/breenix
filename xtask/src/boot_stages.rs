...
fn shared_userspace_stages() -> Vec<BootStage> {
    vec![
        ...
        BootStage {
            ...
            check_hint: "Check kernel exec path resolution and ls (BusyBox) in ext2",
        },
        BootStage {
