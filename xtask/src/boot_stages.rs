...
fn shared_userspace_stages() -> Vec<BootStage> {
    vec![
        ...
        BootStage {
            name: "Exec ext2 /bin/bls OK",
            marker: "EXEC_EXT2_LS_OK",
            failure_meaning: "exec /bin/bls failed",
            check_hint: "Check kernel exec path resolution and bls binary in ext2",
        },
        BootStage {
        ...
        // Coreutil tests (b-prefixed Breenix coreutils)
        BootStage {
            name: "btrue coreutil test passed",
            marker: "TRUE_TEST_PASSED",
            failure_meaning: "/bin/btrue did not exit with code 0",
            check_hint: "Check btrue.rs and true_test.rs",
        },
        BootStage {
            name: "bfalse coreutil test passed",
            marker: "FALSE_TEST_PASSED",
            failure_meaning: "/bin/bfalse did not exit with code 1",
            check_hint: "Check bfalse.rs and false_test.rs",
        },
        BootStage {
            name: "bhead coreutil test passed",
            marker: "HEAD_TEST_PASSED",
            failure_meaning: "/bin/bhead failed to process files correctly",
            check_hint: "Check bhead.rs and head_test.rs",
        },
        BootStage {
            name: "btail coreutil test passed",
            marker: "TAIL_TEST_PASSED",
            failure_meaning: "/bin/btail failed to process files correctly",
            check_hint: "Check btail.rs and tail_test.rs",
        },
        BootStage {
            name: "bwc coreutil test passed",
            marker: "WC_TEST_PASSED",
            failure_meaning: "/bin/bwc failed to count lines/words/bytes correctly",
            check_hint: "Check bwc.rs and wc_test.rs",
        },
        BootStage {
            name: "bwhich coreutil test passed",
            marker: "WHICH_TEST_PASSED",
            failure_meaning: "/bin/bwhich failed to locate commands in PATH",
            check_hint: "Check bwhich.rs and which_test.rs",
        },
        BootStage {
            name: "bcat coreutil test passed",
            marker: "CAT_TEST_PASSED",
            failure_meaning: "/bin/bcat failed to output file contents correctly",
            check_hint: "Check bcat.rs and cat_test.rs",
        },
        BootStage {
            name: "bls coreutil test passed",
            marker: "LS_TEST_PASSED",
            failure_meaning: "/bin/bls failed to list directory contents correctly",
            check_hint: "Check bls.rs and ls_test.rs",
        },
