...
set logging file /Users/wrb/fun/code/breenix.worktrees/ahci-interrupt-driven/turn3-artifacts/gdb-endpoint-state.log
set logging overwrite on
set logging enabled on

echo === TURN3 AHCI CPU0 ENDPOINT STATE ===\n
...
set $TIMER_TICK_COUNT = 0xffff000041b2eaa0
set $TIMER_TICK_HW_COUNT = 0xffff000041b2eae0
set $TIMER_INTERRUPT_COUNT = 0xffff000041b2ec48
