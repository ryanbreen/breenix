...
run: $(iso)
	@qemu-system-x86_64 -smp 1 -hda $(iso) -m 5G -device rtl8139,mac=02:00:00:11:11:11,netdev=network0 -netdev tap,id=network0,script=tap_up,downscript=tap_down -serial stdio 2>&1
