...
set logging file /Users/wrb/fun/code/breenix.worktrees/ahci-interrupt-driven/turn7-artifacts/gdb-endpoint-state.log
set logging overwrite on
set logging enabled on

echo === TURN7 AHCI POLLING ATTRIBUTION ENDPOINT STATE ===\n
target remote 127.0.0.1:9604

set $AHCI_IRQ = 0xffff000041201f80
set $AHCI_ISR_COUNT = 0xffff00004121f230
set $AHCI_ISR_LAST_MPIDR = 0xffff000040233148
set $AHCI_POLLED_COMPLETION_COUNT = 0xffff000041201f88
set $AHCI_POLLED_POST_REGISTRATION_COUNT = 0xffff000041201f90
set $AHCI_POLLED_POST_REG_PRE_SCHEDULER = 0xffff000041201f98
set $AHCI_POLLED_POST_REG_SCHEDULER_RUNNING = 0xffff000041201fa0
