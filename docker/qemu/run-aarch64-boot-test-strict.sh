...
run_single_test() {
    ...
    # simply ran out its 60 iterations without either break firing.
    local ENDED_BY_LOOP=""
    ...
    #                      the loop's own 60 iterations ran out (this
