...
SCHED_STRAND_ORACLE_PATTERN='\[SCHED_STRAND_ORACLE:x86:samples=[1-9][0-9]*:checked=[1-9][0-9]*:stranded=0:running_shape=[0-9]+:ready_shape=[0-9]+:resolved_production=[0-9]+:resolved_exercised=[0-9]+:worst_dwell_ms=[0-9]+:overflow=[0-9]+:worst_nonprogress_ms=[0-9]+\]'
CENSUS_WIDEN_ORACLE_PATTERN='\[CENSUS_WIDEN_ORACLE:x86:baseline_reported=0:armed_reported=1:tid=[1-9][0-9]*:shape=running:nonprogress_axis=1:PASS\]'
