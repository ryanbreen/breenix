...
TIMER_WAKE_LATENCY_ORACLE_PASS_PATTERN='\[TIMER_WAKE_LATENCY_ORACLE:x86:sleep_ms=10:peers=8:rearmers=4:rearms=32:overrun_ms=[0-9]+:bound_ms=100:quantum_ms=50:round_ms=400:peer_max_gap_ms=[0-9]+:peer_gap_bound_ms=2800:wake_enqueues=[1-9][0-9]*:peers_started=8:peers_spinning=8:peers_exited=8:backstops=0:setup_ms=[0-9]+:window_ms=[0-9]+:measured=1:PASS\]'
...
timer_wake_oracle_sample() {
    printf '[TIMER_WAKE_LATENCY_ORACLE:x86:sleep_ms=10:peers=8:rearmers=4:rearms=%s:overrun_ms=%s:bound_ms=100:quantum_ms=50:round_ms=400:peer_max_gap_ms=%s:peer_gap_bound_ms=2800:wake_enqueues=32:peers_started=8:peers_spinning=8:peers_exited=8:backstops=0:setup_ms=120:window_ms=430:measured=1:%s]\n' "$1" "$2" "$3" "$4"
}
