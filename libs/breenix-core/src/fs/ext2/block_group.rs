...
mod tests {
    ...
    fn test_allocate_block_1kb_first_data_block_offset() {
        ...
        let first_data_block = superblock.s_first_data_block;
        assert_eq!(first_data_block, 1, "1KB blocks should have s_first_data_block = 1");
    ...
    fn test_allocate_block_4kb_no_offset() {
        ...
        let first_data_block = superblock.s_first_data_block;
        assert_eq!(first_data_block, 0, "4KB blocks should have s_first_data_block = 0");
    ...
    fn test_allocate_block_bit_295_returns_block_296() {
        ...
        let superblock = create_1kb_superblock();
        // Device must be large enough to zero out block 296 (byte offset 296*1024 + 1024)
