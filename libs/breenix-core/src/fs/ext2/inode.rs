...
impl Ext2Inode {
    ...
    pub fn update_timestamps(&mut self, update_atime: bool, update_mtime: bool, update_ctime: bool) {
        // TODO: In the kernel, this calls crate::time::current_unix_time().
        // For the portable crate, the caller should provide a timestamp or
        // this should be hooked into a platform-specific time source.
        let now = 0u32;
...
pub fn decrement_inode_links<B: BlockDevice + ?Sized>(
    ...
    if new_links == 0 {
        ...
        let _blocks_freed = free_inode_blocks(device, superblock, block_groups, &inode)?;
